...
const CATALOGS = {
  ...
  en: {
    ...
    "hero.demo.proofStatus": "Pending review",
    "hero.demo.stepReward": "Get paid",
    "hero.demo.walletLabel": "Wallet",
    "hero.demo.walletNote": "Added after approval",
    ...
    // ------------------------------------------------ landing: offers
    "offers.title": "Earn from games and apps",
    "offers.subtitle": "Choose an offer, complete the requirement, and submit your proof.",
    ...
    "offers.emptyTitle": "No offers published yet",
    ...
    "categoryPage.emptyTitle": "Nothing here yet",
    ...
    "footer.description": "Complete simple tasks in games and apps, and earn rewards after review.",
    ...
    "offersPage.emptyTitle": "Nothing here yet",
    ...
    "offer.submit.messagePlaceholder": "Anything the reviewer should know…",
    "offer.submit.messageHint": "Optional, but a clear message helps approval.",
    "offer.submit.walletNumber": "Wallet number",
    "offer.submit.walletNumberPlaceholder": "Your payout wallet ID",
    "offer.submit.walletNumberHint": "Used to pay you after approval.",
    ...
    "submissions.emptyBody": "Choose an offer, complete the task, and your submissions will be listed here.",
    "submissions.emptyCta": "Browse offers",

    // ------------------------------------------------ wallet
    "wallet.title": "Your wallet",
    "wallet.subtitle": "Rewards land here after approval. Withdraw whenever you are ready.",
    ...
    "wallet.emptyBody": "Once your first submission is approved, the reward will appear here.",
    ...
    "withdraw.successBody": "Your request is pending review. You will be notified once it is processed.",
  ...
  ar: {
    ...
    "common.demoNotice": "محتوى تجريبي يُعرض في حين عدم نشر عروض حقيقية.",
    ...
    "nav.submissions": "مهامي المُرسلة",
    ...
    "hero.demo.proofStatus": "قيد المراجعة",
    "hero.demo.stepReward": "استلم أموالك",
    "hero.demo.walletLabel": "المحفظة",
    "hero.demo.walletNote": "تُضاف بعد الموافقة",
    ...
    "offers.title": "اكسب من الألعاب والتطبيقات",
    "offers.subtitle": "اختر عرضًا، أنجز المتطلب، وأرسل إثباتك.",
    ...
    "offers.emptyTitle": "لا توجد عروض منشورة بعد",
    ...
    "categoryPage.emptyTitle": "لا يوجد محتوى هنا بعد",
    ...
    "trust.proofTitle": "أنت ترسل الإثبات",
    ...
    "footer.description": "أنجز مهام بسيطة في الألعاب والتطبيقات واكسب مكافآت بعد المراجعة.",
    ...
    "verify.instructions": "افتح الرابط في تلك الرسالة لتأكيد بريدك. إن لم تصل خلال دقائق فتفضّصل مجلد الرسائل غير المرغوبة.",
    ...
    "offersPage.emptyTitle": "لا يوجد شيء هنا بعد",
    ...
    "offer.submit.messagePlaceholder": "أي شيء يجب أن يعرفه المراجع…",
    "offer.submit.messageHint": "اختياري، لكن الرسالة الواضحة تساعد على الموافقة.",
    "offer.submit.walletNumber": "رقم المحفظة",
    "offer.submit.walletNumberPlaceholder": "معرّف محفظتك لاستلام الأموال",
    "offer.submit.walletNumberHint": "يُستخدم لدفع لك بعد الموافقة.",
    ...
    "offer.submit.successCta": "عرض مهامي المُرسلة",
    ...
    // ------------------------------------------------ مهامي المُرسلة
    "submissions.title": "مهامي المُرسلة",
    ...
    "submissions.emptyBody": "اختر عرضًا وأنجز المهمة، وستُدرج طلباتك هنا.",
    "submissions.emptyCta": "تصفّح العروض",

    // ------------------------------------------------ المحفظة
    "wallet.title": "محفظتك",
    "wallet.subtitle": "تصل المكافآت هنا بعد الموافقة. اسحب متى شئت.",
    ...
    "wallet.emptyBody": "بمجرد الموافقة على طلبك الأول ستظهر المكافأة هنا.",
    ...
    "withdraw.successBody": "طلبك قيد المراجعة. سيصلك إشعار بمجرد معالجته.",
    ...
    "notifications.types.withdrawal_approved.body": "تمت الموافقة على سحبك بمبلغ {amount} وجارٍت معالجته.",
    ...
    "profile.pendingTasks": "المهام قيد المراجعة",
    ...
    "admin.offers.form.imageHint": "JPG أو PNG حتى 5 ميغابايت، أو الصق رابط صورة مستضافة. تُستخدم صورة مُولَّدة عند الفراغ.",
    ...
    "admin.content.form.imageHint": "JPG أو PNG أو WebP بحد أقصى 5 ميجابايت، أو الصق رابط صورة. تُستخدم صورة مولّدة عند تركه فارغًا.",
    ...
    "admin.submissions.emptyBody": "ستظهر الطلبات المطابقة لهذا التصفية هنا.",
    ...
    "admin.users.emptyBody": "لا حساب يطابق هذا البحث.",
    ...
    "admin.withdrawals.emptyBody": "ستظهر الطلبات المطابقة لهذا التصفية هنا.",
